...
for element in elements:
    ...
    for response_variable in response_variables:
        spp_exc_raster_list = ap.ListRasters('*growth*')
                            ...
                            for row in cursor:
                                if row[0] == spp_code and row[3] == 0:
                                    ...
                                    if cursor.fields[3] == '{}dep_max'.format(element):
                                        ...
                                        e_exp_denominator = Times(sq_ln_dep_max_div_element1_div_element2, -0.5)
                                        ...
                                        red_growth = 1 - (Divide(numerator_growth, denominator_growth))
                                        red_growth.save(out_raster_save_path)
                                        print '***RED GROWTH saved to***', red_growth
